...
# Forma incorrecta pero funcional de iterar un conjunto
print()
...
print()
for num in range(len(numeros)): # Se itera de acuerdo a la cantidad de elementos de la lista
    print(num)


# Forma correcta de iterar un conjunto por sus índices
print()
